...
Shader "Custom/DiffusishMountain" {
Properties {
    ...
    _VertHeight ("VertexHeight", Float) = 1
...
SubShader {
    ...
    Cull [_CullMode]
CGPROGRAM
#pragma surface surf LambertOverride vertex:vert
...
void vert (inout appdata_full v) {
  // v.vertex.xyz += v.normal * _Amount;
    v.color = lerp(_Color, _Color2, v.vertex.z < _VertHeight);
    //v.color = _Color;
}
